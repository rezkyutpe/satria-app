...
class HistoryController extends Controller
{
    ...
    public function __construct()
    {
        $this->middleware(function ($request, $next) {
            ...
            if ($this->PermissionMenu('subcontractorhistory') == 0  && $this->PermissionMenu('subcontractorhistory-management') == 0 && $this->PermissionMenu('subcontractorhistory-nonmanagement') == 0 && $this->PermissionMenu('subcontractorhistory-proc') == 0 && $this->PermissionMenu('subcontractorhistory-vendor') == 0 && $this->PermissionMenu('subcontractorhistory-whs') == 0) {
    ...
    public function Subcontractorhistory()
    {
        try {
            if ($this->PermissionActionMenu('subcontractorhistory')->r == 1) {
                ...
                return view(
                    'po-tracking/subcontractor/subcontractorhistory',
                    compact(
                        'data',
                        'header_title',
                        'link_newPO',
    ...
    //poHIstoryviewManagement
    public function SubcontractorhistoryManagement()
    {
        try {
            if ($this->PermissionActionMenu('subcontractorhistory-management')->r == 1) {
                ...
                $actionmenu =  $this->PermissionActionMenu('subcontractorhistory-management');
    ...
    public function SubcontractorhistoryNonManagement()
    {
        try {
            if ($this->PermissionActionMenu('subcontractorhistory-nonmanagement')->r == 1) {
                ...
                return view(
                    'po-tracking/subcontractor/subcontractorhistory-nonmanagement',
                    compact(
                        'data',
                        'header_title',
                        'link_newPO',
