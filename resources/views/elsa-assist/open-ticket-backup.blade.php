    ...
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="card card-flush">
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                <a href="{{ url('assist-ticket') }}" class="btn btn-color-gray-600 btn-active-color-primary"><span class="svg-icon svg-icon-5"><i class="fa fa-angle-left fs-2"></i></span>Your Assign TIcket</a>
            </div>
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    @php($no=$no+1)
                        <tr>
                            ...
                            <td class="pe-0" data-order="20">
                                ...
                                <span style="color: grey;font-size:10px">{{ $ticket->dept_reporter }}</span></span>
                            </td>
                            <td class="pe-0">
                                <span class="fw-bolder"> {{ date('d F Y H:i',strtotime($ticket->created_at))}}</span>
                            </td>
                            ...
                            <td class="text-end pe-0" data-order="@if($ticket->assist_id==''){{ 'Not Assign' }}@else {{'Assigned'}} @endif">
                                <div class=">@if($ticket->assist_id=='') {{'badge badge-light-danger'}} @else {{'badge badge-light-primary'}} @endif">@if($ticket->assist_id==''){{ 'Not Assign' }}@else {{ $ticket->assist_name ?? "" }} @endif</div>
                            </td>
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="#" onclick="setAssign({{ $ticket->id }},'Assign Ticket')"class="menu-link px-3" tooltip="New App" data-bs-toggle="modal" data-bs-target="#action-ticket" class="menu-link px-3">Assign to</a>
                                    </div>
                                    @if($ticket->flag==1)
                                        <div class="menu-item px-3">
