                                             ...
                                             <table class="table table-bordered" id="myBom">
                                                    <thead>
                                                        ...
                                                        <tr onclick="myFunctionBom(this)">
                                                            ...
                                                            <td><input type="text" list="list_component" id="component" name="component[]" value="{{ $bom->component }}" autocomplete="off" class="form-control" /></td>
                                                            <td><input type="text" id="component_desc" name="component_desc[]" value="{{ $bom->component_desc }}" autocomplete="off" class="form-control" /></td>
                                                            <td><input type="text" name="qty[]" id="qty" class="form-control" value="{{ $bom->qty }}" autocomplete="off"></td>
                                                            <td><input type="text" name="oum[]" id="oum" class="form-control" value="{{ $bom->oum }}" autocomplete="off">
                                                               </td>
                                                            ...
                                                            <td class="text-center"><a href="#" class="btn btn-danger" onclick="unused({{ $bom->id }})"><i
                                                    ...
                                                    <tr onclick="myFunctionBom(this)">
                                                        ...
                                                        <td style="border: none"></td>
                                                        <td style="border: none"></td>
                                                        <td><a href="#" id="addRowBom" class="btn btn-warning addRowBom"><i
                                            ...
                                            <table class="table table-bordered timeline" id="myTable">
                                                ...
                                                <tbody class="tprocess">
                                                    <tr onclick="myFunction(this)">
                                                        ...
                                                        <td width="100"> <input type="text" name="datediff[]" id="datediff1" readonly class="form-control amountdiff">  <input type="hidden" readonly class="form-control amountproses diffamount1"> </td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td style="border: none"></td>
                                                        <td style="border: none"></td>
                                                        <td style="border: none">Total : <span class="total"> </span></td>
    ...
    $('.addRow').on('click', function () {
     ...
     function addRowBom() {
        ...
        var tr = '<tr>'+
                    ...
                    '<td><input type="text" name="material_qfd[]" id="material_qfd" class="form-control" value="{{ $bom->material_qfd }}" readonly autocomplete="off"></td>'+
                    '<td><input type="text" name="material_desc[]" id="material_desc" class="form-control" value="{{ $bom->material_desc }}" readonly autocomplete="off"></td>'+
                    '<td><input type="text" name="item[]" id="item" class="form-control" value=""  autocomplete="off"></td>'+
                    '<td><input type="text"  id="component" name="component[]" value="" autocomplete="off" class="form-control" /></td>'+
                    '<td><input type="text" id="component_desc" list="list_component" name="component_desc[]" value="" autocomplete="off" class="form-control" /></td>'+
                    '<td><input type="text" name="qty[]" id="qty" class="form-control" value="" autocomplete="off"></td>'+
                    '<td><input type="text" name="oum[]" id="oum" class="form-control" value="" autocomplete="off"></td>'+
                    '<td><input type="hidden" name="flag[]" id="flag{{ $bom->id }}" class="form-control" value="1" autocomplete="off"><input type="text" name="flag_val[]" id="flag_val{{ $bom->id }}" class="form-control" value="Used" autocomplete="off" readonly></td>'+
    ...
    function getsf(sel) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                document.getElementById("pic_nrp").value = response['data'].nrp;
                document.getElementById("pic_email").value = response['data'].email;
                // document.getElementById("val_pn_patria").value = response['data'].pn_patria;
                // document.getElementById("val_pn_vendor").value = response['data'].pn_vendor;
            }
        });
    ...
    function getsf1(sel) {
        ...
        $.ajax({
            ...
            success: function (response) {
                console.log(lgtr);
                console.log(response['data']);
                document.getElementById("pic"+lgtr).value = response['data'].nama;
                document.getElementById("pic_nrp"+lgtr).value = response['data'].nrp;
                document.getElementById("pic_email"+lgtr).value = response['data'].email;
                // document.getElementById("val_pn_patria").value = response['data'].pn_patria;
                // document.getElementById("val_pn_vendor").value = response['data'].pn_vendor;
            }
        });
