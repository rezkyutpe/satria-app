                                            ...
                                            <table class="table table-bordered timeline">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td style="border: none"></td>
                                                        <td style="border: none"></td>
                                                        <td style="border: none">Total Lead Time: {{ $totaldifproses+$totaldif }} Days</td>
                                                        
                                                        <td align="right">
                                                            @if($data['trxmat']->status==0 || $data['trxmat']->status==31)
                                                            ...
                                                            @elseif($data['trxmat']->status==99)
                                                               <article class="panel panel-danger panel-outline">
                                                                    <div class="panel-heading icon">
                                                                        <i class="fa fa-times-circle fa-lg custom--1"></i>
                                                                    </div>
                                                                    <div class="panel-body">
                                                                        Canceled at : {{ $data['trxmat']->updated_at  }}
                                                                    </div>
                                                                </article>
