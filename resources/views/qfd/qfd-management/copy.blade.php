...
<div class="content-body-white">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-4 m-b-10px">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="productspec" class="form-control"
                                                autocomplete="off" />
                                                <input type="hidden" name="productspec_old" value="{{ $data['trxmat']->file }}" class="form-control"
                                                autocomplete="off" />
                                        </div>
                                    ...
                                    <div class="col-xl-4 col-md-4 m-b-10px">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $data['trxmat']->no_so }}" name="no_so" autocomplete="off" class="form-control" />
                                     ...
                                     <div class="col-xl-4 col-md-4 m-b-10px">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $data['trxmat']->cust }}"  name="cust" autocomplete="off" class="form-control" />
                                     ...
                                     <div class="col-xl-4 col-md-4 m-b-10px">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $data['trxmat']->qty }}" name="qty_item" autocomplete="off" class="form-control" />
                                      ...
                                      <div class="col-xl-4 col-md-4 m-b-10px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="attendance" value="{{ $data['trxmat']->attendance }}" list="attendance" multiple data-list-filter="^" class="form-control" placeholder="Type your mail attendance" />
 ...
 <input type="hidden" value="{{ $diffproses }}" readonly class="form-control amountproses diffamount{{ $no }}"> 
                                                        ...
                                                        <td><input type="text" list="list_pic" name="pic[]" onchange="getsf(this)"  value="{{ $trxmatdetail->pic }}"  id="pic{{ $no }}" autocomplete="off"
                                                               class="form-control" required />
                                                            <datalist id="list_pic">
                                                                @foreach($data['emp'] as $emp)
                                                                <option value="{{ $emp['nrp'] }}">{{ $emp['nama'] }}</option>
                                                                    @endforeach
                                                            </datalist> <input type="hidden" name="pic_nrp[]" id="pic_nrp{{$no}}" class="form-control" value="{{ $trxmatdetail->pic_nrp }}"  autocomplete="off"> <input type="hidden" name="pic_email[]" id="pic_email{{$no}}" value="{{ $trxmatdetail->pic_email }}"  class="form-control" autocomplete="off"> </td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <input id="myBtn" type="submit" name="submit" value="Save" class="btn btn-info">
                                                            <input id="myBtn" type="submit" name="submit"
...
<script type="text/javascript">
    ...
    function addRowBom() {
       ...
       var tr = '<tr>'+
                    ...
                    '<td class="text-center"><a href="#" class="btn btn-danger remove"><i class="glyphicon glyphicon-remove"></i></a></td>'+
                '</tr>';
        $('.tbom').append(tr);
    ...
    function addRow() {
       ...
       var tr = '<tr onclick="myFunction(this)">' +
        '<td><article class="panel panel-info panel-outline"><div class="panel-heading icon"><i class="glyphicon glyphicon-info-sign"></i></div><div class="panel-body diffproses' + lgtr + ' amountproses"></div></article></td>'+
            ...
            ' <input type="hidden" name="pic_nrp[]" id="pic_nrp' + lgtr + '" class="form-control" autocomplete="off"> <input type="hidden" name="pic_email[]" id="pic_email' + lgtr + '" class="form-control" autocomplete="off"> <td> <input type="text" name="remark[]" id="remark' + lgtr + '" class="form-control" autocomplete="off"> </td>'+
