                        ...
                        <div class="card-body text-white">
                            <div class="media d-flex" style="position: relative">
                                <div class="media-body text-left">
                                    <h1>{{ $data['CountAPCR'] }}</h1>
                                    <h3 style="font-weight: bold;">Open Status APCR </h3>
                                </div>
                                <div class="cardicons">
                ...
                <div class="col">
                    ...
                    <div class="card baseBlock h-75" style="background: rgb(10, 110, 1);">
                        <div class="card-body text-white">
                            <div class="media d-flex" style="position: relative">
                                <div class="media-body text-left">
                                    <h3>{{ $data['CountCreatedCOGS'] }}</h3>
                                    <h5 style="font-weight: bold;">Created</h5>
                                </div>
                                <div class="cardicons">
                ...
                <div class="col">
                    ...
                    <div class="card baseBlock h-75" style="background: rgb(139, 7, 2);">
                        <div class="card-body text-white">
                            <div class="media d-flex" style="position: relative">
                                <div class="media-body text-left">
                                    <h3>{{ $data['CountNotCreatedCOGS'] }}</h3>
                                    <h5 style="font-weight: bold;">Not Created</h5>
                                </div>
                                <div class="cardicons">
