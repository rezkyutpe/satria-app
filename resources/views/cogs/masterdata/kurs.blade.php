    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Kurs</h2>
                @if($actionmenu->u==1)
                <a class="btn btn-refresh btn-success btn-sm pull-right" href="{{ url('cogs-import-kurs') }}">Update
                    Database
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <table id="datatable-visibility-kurs" class="table text-center table-striped table-bordered"
...
@section('myscript')
<script>
$('#datatable-visibility-kurs').DataTable({
    stateSave: true,
    dom: 'Bfrtip',
    buttons: [
