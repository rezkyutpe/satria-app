        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <a class="btn btn-refresh btn-success btn-sm pull-right"
                    href="{{ url('cogs-import-purchasinginforecord') }}">Update Database
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <table id="datatable-visibility-pir" class="table text-center table-striped table-bordered"
...
@section('myscript')
<script>
$('#datatable-visibility-pir').DataTable({
    processing: true,
    serverSide: true,
    // stateSave: true,
    // ordering: false,
    ...
    ajax: {
        url: "{{ url('cogs-search-pir') }}",
        type: 'GET',
    },
    "drawCallback": function(settings) {
        alert('Data sukses diakses !');
    },
    columns: [{
            data: 'ID',
            name: 'ID'
