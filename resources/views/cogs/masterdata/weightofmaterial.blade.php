...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Weight of Material</h2>
                @if($actionmenu->u==1)
                <a class="btn btn-refresh btn-success btn-sm pull-right"
                    href="{{ url('cogs-import-weightofmaterial') }}">Update Database <i class="fa fa-refresh">
                    </i>
                </a>
                @endif
                <div class="clearfix"></div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <table id="datatable-visibility-weightofmaterial"
...
@section('myscript')
<script>
$('#datatable-visibility-weightofmaterial').DataTable({
    stateSave: true,
    dom: 'Bfrtip',
    buttons: [
