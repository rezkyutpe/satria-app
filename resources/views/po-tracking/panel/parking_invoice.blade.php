    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: auto;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{url('parkinginvoice')}}" enctype="multipart/form-data">
                @csrf
            ...
            `);
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        ...
                        <input id="upload_file_pdf" type="file" name="filename[]" data-show-upload="false" data-show-caption="true" multiple capture="camera" accept=".pdf" required>
