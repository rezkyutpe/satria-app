        ...
        <div class="col">
            ...
            <div class="card baseBlock h-75" style="cursor:pointer; background: rgb(139, 7, 2);">
                <div class="card-body text-white">
                    <div class="media d-flex" style="position: relative">
                        <div class="media-body text-left">
                            <h3>{{ $countNewpoSubcont ?? 0}} <div style="display: inline-block; font-size:1rem">Items</div> </h3>
                ...
                {{-- <div class="card-footer bg-white text-center" >
                    <a href="{{ url('polocalnewpo') }}" >Show Data</a>
                </div> --}}
            </div>
        </a>
        </div>
        ...
        <div class="col">
            ...
            <div class="card baseBlock h-75" style="background: #01116b;cursor:pointer">
                <div class="card-body text-white">
                    <div class="media d-flex" style="position: relative">
                        <div class="media-body text-left">
                        <h3>{{$countOngoingSubcont ?? 0}} <div style="display: inline-block; font-size:1rem">Items</div> </h3>
        ...
        <div class="col">
            ...
            <div class="card baseBlock h-75" style="background: rgb(141, 81, 2);cursor:pointer">
                <div class="card-body text-white">
                    <div class="media d-flex" style="position: relative">
                        <div class="media-body text-left">
                        <h3>{{$countPlanDeliverySubcont ?? 0}} <div style="display: inline-block; font-size:1rem">Items</div> </h3>
           ...
           <a href="{{ url($link_readyToDelivery) ?? '#'}}" >
            <div class="card baseBlock h-75" style="background: rgb(10, 110, 1);cursor:pointer">
                <div class="card-body text-white">
                    <div class="media d-flex" style="position: relative">
                        <div class="media-body text-left">
                        <h3>{{$countReadyToDeliverySubcont ?? 0}} <div style="display: inline-block; font-size:1rem">Items</div> </h3>
        ...
        <div class="col">
            ...
            <div class="card baseBlock h-75" style="background: rgb(2, 128, 111);cursor:pointer">
                <div class="card-body text-white">
                    <div class="media d-flex" style="position: relative">
                        <div class="media-body text-left">
                        <h3>{{$countHistorySubcont ?? 0}} <div style="display: inline-block; font-size:1rem">Items</div> </h3>
