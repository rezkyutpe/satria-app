 ...
 <div class="modal fade" id="ponegotiated" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered " style="max-width: 900px;">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('update-po')}}" enctype="multipart/form-data">
                {{csrf_field()}}
...
<script>
    $(document).ready(function() {
        ...
        $('#datatable-responsive tbody').on('click', '.negosiasi', function ()
        {
                ...
                $.ajax({
                url : "{{url('view_negosiasipo')}}?number="+number+"&item="+item,
                    type: "GET",
                    dataType: "JSON",
                    success: function(data)
                    {
                        ...
                        if(data.data[i].req_date == null){
                            ...
                            `
                                ...
                                `;
                                if(data.actionmenu.u==1 || data.actionmenu.r==1) {
                                    html+=`<td>`+ReqDate+`</td>`;
                                }
                            html +=`
                                </tr>
