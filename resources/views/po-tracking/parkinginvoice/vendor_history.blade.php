                                    ...
                                    <tbody>
                                        @foreach ($dataPI as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ date('d/m/Y', strtotime($item->InvoiceDate)) }}</td>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        @if($item->Status == "Reject Parking")
                                                            <a href="javascript:;" id="parking_detail" class="badge badge-danger parkinginvoice_detail" data-parking="{{ $item->InvoiceNumber }}" data-created="{{ $item->created_at }}">Cancelled</a>
                                                        @else
