                    ...
                    <td>
                        <div style="margin-left:20px">
                            <center>
                                ...
                                <span>Jln.Jababeka XI Blok H30-40 Kawasan Industri Jababeka Cikarang
                                    17530-Indonesia</span>
                            </center>
                        </div>
                    </td>

                    <td width="160">
                        <img style="margin : -30px 5px auto 10px" src="data:image/png;base64, {!! $qrcode !!}"
                            height="160">
                    </td>
                </tr>
            </table>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td>
                            <center>
                                <h2>DELIVERY TICKET <br>
                                    @if ($dataviewticket->Plant = 'UCKR' && ($dataviewticket->Plant = 'PCKR'))
                                        @if (substr($dataviewticket->TicketID, 0, 6) == 'PTR/PR')
                                            CIKARANG
                                        @else
                                            KANBAN
                                        @endif
                                    @elseif ($dataviewticket->Plant = 'RJKT')
                                        JAKARTA
                                    @elseif ($dataviewticket->Plant = 'RPKB')
                                        PEKANBARU
                                    @elseif ($dataviewticket->Plant = 'RTJE')
                                        TANJUNG ENIM
                                    @elseif ($dataviewticket->Plant = 'RBJN')
                                        BANJARMASIN
                                    @elseif ($dataviewticket->Plant = 'RTMK')
                                        TIMIKA
                                    @else
                                        -
                                    @endif
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <th>Vendor Code</th>
                        <td>: {{ $dataviewticket->VendorCode_new }}</td>
                    </tr>
                    <tr>
                        <th>NO Surat Jalan</th>
                        <td>: {{ $dataviewticket->DeliveryNote }}</td>
                        <th>Header Text</th>
                        <td>: {{ $dataviewticket->headertext }}</td>
                    </tr>
                    <tr>
