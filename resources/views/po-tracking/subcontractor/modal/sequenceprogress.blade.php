        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                for(i=0;i<data.dataall.length;i++){
                    ...
                    if((data.dataall[i].ActiveStage == '3' || data.dataall[i].ActiveStage == null)){
                        var navlinksetting = 'disabled';
                        var navlinkfullweld = 'disabled';
                        var navlinkprimer = 'disabled';
                    }
                    if(data.dataall[i].ActiveStage == '3a'){
                        var navlinksetting = '';
                        var navlinkfullweld = 'disabled';
                        var navlinkprimer = 'disabled';
                    }
                    if(data.dataall[i].ActiveStage == '3b'){
                        var navlinksetting = '';
                        var navlinkfullweld = '';
                        var navlinkprimer = 'disabled';
                    }
                    if(data.dataall[i].ActiveStage == '3c'){
                        var navlinksetting = '';
                        var navlinkfullweld = '';
                        var navlinkprimer = '';
                    }
