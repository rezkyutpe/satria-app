<div class="modal fade" id="Ticketing" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: auto;">
        <div class="modal-content">
            ...
            <form method="post" id="formTicketing" action="{{ url('subcontractorcreateticket') }}"
...
<script>
    ...
    $(document).ready(function() {
        $('#datatable-responsive tbody').on('click', '.Ticketing', function() {
            ...
            $.ajax({
                url: "{{ url('view_cekticketsubcont') }}?id=" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                        ...
                        <div class="row m-4">
                                <table class="table table-md table-hover">
                                    <thead class="thead-light">
                                        ...
                                        <tr>
                                            <th style="vertical-align:middle;">NO Surat Jalan</th>
                    ...
                    for (i = 0; i < data.dataticket.length; i++) {
                        ...
                        // if (data.dataticket[i].NetPrice >= 10000000) {
                        //     if (data.dataticket[i].totalticket == null) {
                        //         var sisa = data.dataticket[i].totalticketinsp_good - data
                        ...
                        html += `
                                    <input type="hidden" name="number[]" disabled value="` + data.dataticket[i]
                            .Number + `">
                            ...
                            .Description + `">
                                    <input type="hidden"  name="id_qc[]" disabled  value="` + data.dataticket[i]
                            .id_qc + `">
                                    <input type="hidden" name="qtysap[]" disabled  value="` + qty + `">
