                                    ...
                                    @foreach ($data as $item)
                                        @php
                                            ...
                                            if ($item->SecurityDate == null) {
                                                ...
                                                $securitys = $security->format('d/m/Y H:i:s');
                                            }
    ...
    <div class="modal fade" id="Update" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{ url('prosesreverseticket-local') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
...
@section('top_javascript')
    ...
    {{-- Modal View_ticket  --}}
    @include('po-tracking.polocal.modal.view_ticket')
@endsection
