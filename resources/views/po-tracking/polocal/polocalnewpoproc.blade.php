...
@section('top_javascript')
                 ...
                 buttons: [
...

                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            window.location.href = "{{ url('po-open-download/polocalnewpo/1') }}";
                        }
                    }
                ],
                select                          : true,
    ...
    {{-- Modal negosiasi  --}}
    @include('po-tracking.polocal.modal.confirm_po')
    {{-- Modal confirmpo --}}
    @include('po-tracking.polocal.modal.negosiasi_po')
    {{-- Modal cancel po --}}
    @include('po-tracking.polocal.modal.po_cancel')
