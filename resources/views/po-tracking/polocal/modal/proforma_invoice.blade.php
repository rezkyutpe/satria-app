    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: auto;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{url('proses-polocalongoing')}}" enctype="multipart/form-data">
                @csrf
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        ...
                        $("#modalfooter").append
                            ...
                            `);
                    }else if(data.dataid.ActiveStage == 3){
                            $("#Judul").append
                        (`
                        ...
                        $("#proformauploud").append
                            ...
                            <input type="file" name="filename" required>
                            <input type="submit" name="action" value="Download" class="btn btn-danger btn-sm" formtarget="_blank">
