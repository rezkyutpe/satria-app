...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      <div class="x_title">
        <h2>Sequence Progress Reason  </h2>
...
<div class="modal fade" id="delete" aria-hidden="true">
    <form method="post" action="{{url('delete-reasonsubcont')}}" enctype="multipart/form-data">
      {{csrf_field()}}
...
<div class="modal fade" id="modal-edit" aria-hidden="true">
    <form method="post" action="{{url('update-reasonsubcont')}}" enctype="multipart/form-data">
        {{csrf_field()}}
...
<div id="modal-add-appsmenu" class="modal fade"   aria-hidden="true">
    <form method="post" action="{{url('insert-reasonsubcont')}}" enctype="multipart/form-data">
      {{csrf_field()}}
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    <h2>Add Sequence Progress Reason</h2>
                    <br>
                    <div class="form-group text-left">
                        <label class="form-control-label"> Name: *</label>
