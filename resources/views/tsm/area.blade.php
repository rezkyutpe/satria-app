    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Area</h2>
                @if($actionmenu->u==1)
                <a class="btn btn-refresh btn-success btn-sm pull-right" href="{{ url('tsm-import-area') }}">Update
                    Area <i class="fa fa-refresh">
                    </i>
                </a>
                @endif
                <div class="clearfix"></div>
            ...
            <div class="x_content">
                <div class="row content-table">
                    <div class="col-sm-12 ">
                        <div class="card-box">
                            <table id="datatable-visibility-area"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i+1 }}</td>
                                        <td class="text-left"><b>{{ $item->area }}</b></td>
                                        <td>{{ $item->plant }}</td>
...
$(document).ready(function() {
    $('#datatable-visibility-area').DataTable({
        scrollX: true,
        stateSave: true,
        dom: 'Bfrtip',
        buttons: [
