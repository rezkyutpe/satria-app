    ...
    <div class="card shadow">
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea name="note" id="note" rows="5" class="form-control mb-3" placeholder="Catatan progres respon keluhan"></textarea>
...
<div class="modal-footer">
    <div class="inline">
        <button class="btn btn-success float-right" onclick="updateResponse('{{ $keluhan->id }}')">Ya</button>
