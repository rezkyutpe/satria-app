...
@section('content')
    ...
    <div class="card shadow">
        <div class="">
            <div class="card-header">
                <div class="d-flex">
                    <h4 class="mr-3">Data Lokasi Maintain</h4>
    ...
    <script>
        ...
        function read(){
            $.get("{{ url('/lokasi-maintain-read') }}",{}, function(data, status){
                $('.card-body').html(data);
                // alert(data);
            })
        }
        ...
        function create(){
            ...
            $.get("{{ url('/lokasi-maintain/create') }}", {}, function(data, status){
                // alert(data);
        ...
        function edit(id){
            $.get("{{ url('/lokasi-maintain') }}/"+id+"/edit", {}, function(data, status){
                $('.modal-content').html(data);
                $('#modal').modal('show');
            }) 
        }
        ...
        function del(id){
            $.get("{{ url('/lokasi-maintain-delete') }}/"+id, {}, function(data, status){
                $('.modal-content').html(data);
                $('#modal').modal('show');
            }) 
        }
