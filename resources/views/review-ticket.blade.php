        ...
        <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
          ...
          <form action="{{url('rate-ticket')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="modal-header">
                <strong>Review Ticket</strong>
              Ticket {{ $data['ticket']->flow_name }} : {{ date('d F Y, H:i',strtotime($data['ticket']->updated_at))}}
              </div> <!-- Modal Body-->
              <div class="modal-body">
              <strong><i class="bi bi-person"></i> Assister<br>
                                    <span style="color: grey;font-size:12px">{{  $data['ticket']->assist_name }}</span> -
                                    <span style="color: grey;font-size:12px">{{  $data['ticket']->dept_assist }}</span> <br>
