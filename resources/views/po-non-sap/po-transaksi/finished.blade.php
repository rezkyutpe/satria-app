                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a href="#" data-toggle="modal" data-target="#modal-close-transaction-{{ $po->nopo }}"><i class="fa fa-check-square fa-lg custom--1"></i></a>
                                @endif
                                @if($data['actionmenu']->v==1)
                                <a href="{{ url('print-finished/'.$po->nopo) }}" ><i class="fa fa-file-pdf-o fa-lg custom--1"></i></a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
...
<div id="modal-close-transaction-{{ $po->nopo }}" class="modal fade">
        <form method="post" action="{{url('close-transaction')}}" enctype="multipart/form-data">
          {{csrf_field()}}
