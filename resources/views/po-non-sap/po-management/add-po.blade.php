                                        ...
                                        <fieldset>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                    	<td>1</td>
                                                        <td><input type="text" name="pn_patria[]" id="val_pn_patria"
                                                        ...
                                                        <td>
                                                            <select id='sel_desc' class="form-control js-example-basic-single" data-live-search="true"
                                                                ...
                                                                <option value='{{ $komponen->pn_patria }}'>
                                                                    {{ $komponen->pn_patria." - ".$komponen->description }}</option>
                                                                @endforeach
                                                        ...
                                                        <td><input type="text" name="pn_vendor[]" id="val_pn_vendor"
                                                                class="form-control" autocomplete="off" readonly></td>
                                                        <td><input type="text" name="uom[]" id="val_uom"
                                                                class="form-control" autocomplete="off" readonly></td>
                                                        <td><input type="text" id="quantity" onchange="cekQty(this);" name="quantity[]"
...
<script type="text/javascript">
    ...
    function addRow() {
        ...
        var tr = '<tr>' +
            '<td>' + no + '</td>'+
            '<td><input type="text" name="pn_patria[]" id="val_pn_patria' + lgtr + '" class="form-control" autocomplete="off" required="" readonly></td>' +
