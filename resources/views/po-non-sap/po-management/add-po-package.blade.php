    ...
    <form method="post" action="{{url('insert-picking')}}" enctype="multipart/form-data">
        ...
        <div class="page-head">
            <div class="page-title">
                <h1>Create Picking List From Package</h1>
            </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $i }}</td>
                                                        <td><input type="text" value="{{ $package->name }}" name="pn_patria[]" id="val_pn_patria1"
                                                                class="form-control" autocomplete="off" required readonly>
                                                              
                                                        <!-- <td><input type="text" name="desc[]" class="form-control" autocomplete="off"></td>    -->
                                                        <td><input type="text" value="{{ $package->descr }}" name="desc[]" id="desc"
                                                                class="form-control" autocomplete="off" required readonly>
                                                                <input type="hidden" name="description[]" id="val_descrip"
                                                                class="form-control" autocomplete="off"  value="{{ $package->descr }}" required=""
                                                                readonly></td>
                                                           </td>
                                                        </td>
                                                        <td><input type="text" name="pn_vendor[]" id="vaL_pn_vendor" value="{{ $package->pn_eaton }}"
