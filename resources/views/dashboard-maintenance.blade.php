        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card card-page">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-2 ms-auto mb-5">
                            <a href="{{ url('pr-list') }}" type="submit"
                                class="btn btn-sm btn-primary fs-7 w-100">Go To PR LIST</a>
                        </div>
                    </div>
                    @endif
                    <!--begin::Row-->
                                            ...
                                            @if (count($ticketassign) > 0)
                                                @foreach ($ticketassign as $ta)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="text-gray-800 fw-bold">{{ $ta->desc_mesin }}</span>
                                                        </td>
                                                        <td>
                                                            <span class="text-gray-800 fw-bold">{{ $ta->location }}</span>
                                                        </td>
                                                        <td>
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    ...
                                                                    @elseif($ta->flag == 2 || $ta->flag == 3 || $ta->flag == 9)
                                                                        @if ($ta->flag != 3)
                                                                            ...
                                                                            <div class="menu-item px-3">
                                                                                <a href="#"
                                                                                    onclick="setResolve({{ $ta->id }},'Resolve',{{ $ta->asset_id }})"
                                                                                    class="menu-link px-3" tooltip="New App"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#action-ticket"
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4">
                                        ...
                                        <thead class="">
                                              <tr class="fs-7 fw-bold border-0 text-gray-400">
                                                ...
                                                <th class="min-w-150px">ID TICKET</th>
                                                <th class="min-w-100px">DATE</th>
                                                <th class="min-w-75px">MESIN</th>
                                                <th class="min-w-75px">LOKASI</th>
                                                <th class="min-w-75px">PROBLEM</th>
                                                <th class="min-w-50px">REPORTER</th>
                                            ...
                                            @if (count($ticketopened) > 0)
                                                @foreach ($ticketopened as $to)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="text-gray-800 fw-boldest text-hover-primary">#{{ $to->ticket_id }} 
                                                                @if($to->status <=3) 
                                                                    @if($to->status ==3) 
                                                                    <div class="badge badge-light-primary">
                                                                        {{ "Fully Approved" }} 
                                                        ...
                                                        <td class="pe-0 text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                                                ...
                                                                <!--begin::Heading-->
                                                                <div class="menu-item px-3">
                                                                    <a onclick="getHistory({{ $to->id }})"class="menu-link px-3"
                                                                        tooltip="New App" data-bs-toggle="modal"
                                                                        data-bs-target="#detail-ticket"
                                                                        class="menu-link px-3">Detail</a>
                                                                </div>
                                                                ...
                                                                @if ($to->status >= 3)
                                                                    <div class="menu-item px-3">
                                                                        <a onclick="setAssign({{ $to->id }},'Assign Ticket')"class="menu-link px-3"
                                                                            tooltip="New App" data-bs-toggle="modal"
                                                                            data-bs-target="#action-ticket"
                                                                            class="menu-link px-3">Assign to</a>
                                                                    </div>
                                                                    @if(Auth::user()->dept == '8915')
                                                                    @if ($to->status == 4)
                                                                    <div class="menu-item px-3">
                                                                            <a onclick="setApproval({{ $to->id }},'Request Approval')"
                                                                                class="menu-link px-3" tooltip="New App"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#action-ticket"
                                                                            class="menu-link px-3">Request Approval</a>
                                                                    </div>
                                                                    @endif
                                                                    @endif
                                                                    @if ($to->flag == 1)
                                                                        <div class="menu-item px-3">
                                                                            <a onclick="setProccess({{ $to->id }},'Proccess')"
                                                                                class="menu-link px-3" tooltip="New App"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#action-ticket"
                                                                                class="menu-link px-3">Proccess</a>
                                                                        ...
                                                                        <div class="menu-item px-3">
                                                                            <a onclick="setCancel({{ $to->id }},'Cancel')"
                                                                                class="menu-link px-3" tooltip="New App"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#action-ticket"
                                                                                class="menu-link px-3">Cancel</a>
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4">
                                        ...
                                        <thead class="">
                                            <tr class="fs-7 fw-bold border-0 text-gray-400">
                                                ...
                                                <th class="min-w-150px">ID TICKET</th>
                                                <th class="min-w-100px">DATE</th>
                                                <th class="min-w-70px">MESIN</th>
                                                <th class="min-w-70px">LOKASI</th>
                                                <th class="min-w-70px">PROBLEM</th>
                                                <th class="min-w-50px">REPORTER</th>
                                                <th class="min-w-100px">STATUS</th>
                                            ...
                                            @if (count($allticketassign) > 0)
                                                @foreach ($allticketassign as $ata)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="text-gray-800 fw-boldest text-hover-primary">#{{ $ata->ticket_id }} </span><br> <p>
                                                                	{{ date_format($ata->created_at, 'H:i:s, d M Y') }} </p>
                                                        </td>
                                                        <td>
                                                            <span
                                                        ...
                                                        <td class="pe-0 text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                                                ...
                                                                @if ($ata->flow_name == 'Opened')
                                                                    <div class="menu-item px-3">
                                                                        <a onclick="setAssign({{ $ata->id }},'Assign Ticket')"class="menu-link px-3"
                                                                            tooltip="New App" data-bs-toggle="modal"
                                                                            data-bs-target="#action-ticket"
                                                                            class="menu-link px-3">Assign to</a>
                                                                    </div>
                    ...
                    <div class="row mx-0 mt-3 gy-5 g-xl-8">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-body pt-5">
                                @if (count($newtcd2) > 0)
                                    <input type="hidden" name="def_startdate_export" value="{{ reset($newtcd2) }}">
                                    <input type="hidden" name="def_enddate_export" value="{{ end($newtcd2) }}">
                                @endif
                                <div class="row">
                                    <div class="col-md-8">
    ...
    <div class="modal fade" id="action-ticket" tabindex="-1" aria-hidden="true">
        ...
        <script>
            function filterTR() {
                ...
                $.ajax({
                    url: "{{ url('filter-ticket-req') }}?Start_tr=" + start_tr + "&End_tr=" + end_tr,
                    type: "GET",
            ...
            function filterYTA() {
                ...
                $.ajax({
                    url: "{{ url('filter-your-ticket-req') }}?Start_yta=" + start_yta + "&End_yta=" + end_yta,
                    type: "GET",
                    success: function(response) {
                        var data = JSON.parse(response);
                        ...
                        // console.log(data);
                        // console.log(data[1].resolve_time);
                        $('.tbody_yta').empty();
                        if (data.length > 0) {
                                ...
                                if (data[i].flag == 1) {
                                    ...
                                    if (data[i].flag != 3) {
                                        var html = `<div class="menu-item px-3">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="#"
                                                        onclick="setResolve(` + data[i].id + `,'Resolve',` + data[i].id + `)"
                                                        class="menu-link px-3" tooltip="New App"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#action-ticket"
                                                        class="menu-link px-3">Resolve</a>
            ...
            function filterLTO() {
                ...
                $.ajax({
                    url: "{{ url('filter-list-ticket-open') }}?Start_lto=" + start_lto + "&End_lto=" + end_lto,
                    type: "GET",
                    success: function(response) {
                        var data = JSON.parse(response);
                        $('#tbody_lto').empty();
                                    ...
                                    `; color: ` + data[i].fg_color + `;">
                                                        ...
                                                        <td class="pe-0 text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a onclick="setAssign(` + data[i].id + `,'Assign Ticket')"class="menu-link px-3"
                                                                        tooltip="New App" data-bs-toggle="modal"
                                                                        data-bs-target="#action-ticket"
                                                                        class="menu-link px-3">Assign to</a>
                                                                </div>` + html + `
            ...
            function filterATA() {
                ...
                $.ajax({
                    url: "{{ url('filter-all-ticket-assign') }}?Start_ata=" + start_ata + "&End_ata=" +
                        end_ata,
                    type: "GET",
                    success: function(response) {
                        var data = JSON.parse(response);
                        ...
                        if (data.length > 0) {
                            for (i = 0; i < data.length; i++) {
                                ...
                                if (data[i].assist_name != null) {
                                    var html2 = data[i].assist_name;
                                } else {
                                    var html2 = ``;
                                }
                                if (data[i].flow_name == 'Opened') {
                                    var htmlata = `<div class="menu-item px-3">
                                                        <a onclick="setAssign(` + data[i].id + `,'Assign Ticket')"class="menu-link px-3"
                                                            tooltip="New App" data-bs-toggle="modal"
                                                            data-bs-target="#action-ticket"
                                                            class="menu-link px-3">Assign to</a>
                                ...
                                var new_tbodyATA =
                                    ...
                                    `; color: ` + data[i].fg_color + `;">
                                                        ...
                                                        <td>
                                                            <span
                                                                class="text-gray-800 fw-bold">` + html2 + `</span>
                                                        </td>
                                                        <td class="pe-0 text-end">
                                                            <a class="btn btn-sm btn-icon btn-color-gray-500 btn-active-color-primary"
                                                                data-kt-menu-trigger="click" data-kt-menu-overflow="true"
            ...
            function filterTRENDS() {
                ...
                $.ajax({
                    url: "{{ url('filter-trends') }}?Start_trends=" + start_trends + "&End_trends=" + end_trends,
                    type: "GET",
                    success: function(response) {
                        var data = JSON.parse(response);
                        console.log(data);
            ...
            function filterTICKETTOTAL() {
                ...
                $.ajax({
                    url: "{{ url('filter-ticket-total') }}?Start_totalticket=" + Start_totalticket +
                    ...
                    success: function(data) {
                        ...
                        console.log(chartdata['newtrbar2']);
        ...
        <script type="text/javascript">
            ...
            function setResolve(x, s,y) {
                $('#ticketAction').empty();
                var tools = "";
                console.log(y);
                if(y==null){
                    tools = `<div class="fv-row mb-15">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                        @if(Auth::user()->dept == '8884')
            ...
            function setApproval(x, s) {
                $('#ticketAction').empty();
                var tr_str = `<div class="text-center mb-13">
                    <h1 class="mb-3">` + s + ` Ticket</h1>
                    <div class="text-muted fw-bold fs-5">Are you sure the to 
                    <a class="link-primary fw-bolder">` + s + `</a> Ticket</div>
                </div>   <form action="{{ url('request-approval-ticket') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="fv-row">
                    <div class="fv-row mb-10">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
